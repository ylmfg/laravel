...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="{{url('index')}}">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="{{url('zuoping')}}">作品管理</a><span class="crumb-step">&gt;</span><span>编辑作品</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                ...
                @endif
                <form action="{{url('insertProccess')}}" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="{{$productList->title}}" type="text">
                                </td>
                            </tr>
                             <tr>
                             ...
                             <tr>
                              ...
                              <tr>
                                ...
                                <td><input class="common-text" name="keyword" size="50" value="{{$productList->keyword}}" maxlength="20" type="text"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th></th>
                                <td id="thumb">
                                @foreach($productList->thumb as $thumb)
                                <div style="margin-left:10px;float:left;width:100px;height:100px;position:relative;">
                                    <img style="width:100px;height:100px;" src="/{{$thumb}}">
                                    <span class="del" style="position:absolute;right:0px;top:-8px;">
                                        <img src="/public/AdminHome/images/delete.png">
                                    </span>
